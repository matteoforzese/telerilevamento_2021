...
MSH1979 <- unsuperClass(H1979$STHE79.2, nClasses=3,stretch="lin",nStarts = 3)
MSH1980 <- unsuperClass(H1980$STHE80.2, nClasses=3,stretch="lin",nStarts = 3)
MSH1982 <- unsuperClass(H1982$STHE82.2, nClasses=3,stretch="lin",nStarts = 3)
MSH1986 <- unsuperClass(H1986$STHE86.1, nClasses=3,stretch="lin",nStarts = 3)
MSH1990 <- unsuperClass(H1990$STHE90.1, nClasses=3,stretch="lin",nStarts = 3)
MSH1993 <- unsuperClass(H1993$STHE93.1, nClasses=3,stretch="lin",nStarts = 3)
MSH1998 <- unsuperClass(H1998$STHE98.1, nClasses=3,stretch="lin",nStarts = 3)
MSH2002 <- unsuperClass(H2002$STHE02.1, nClasses=3,stretch="lin",nStarts = 3)
MSH2006 <- unsuperClass(H2006$STHE06.1, nClasses=3,stretch="lin",nStarts = 3)
MSH2010 <- unsuperClass(H2010$STHE10.1, nClasses=3,stretch="lin",nStarts = 3)
MSH2015 <- unsuperClass(H2015$STHE15.1, nClasses=3,stretch="lin",nStarts = 3)
